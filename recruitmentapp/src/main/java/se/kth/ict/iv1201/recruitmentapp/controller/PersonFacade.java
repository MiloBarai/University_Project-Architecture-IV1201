...
import se.kth.ict.iv1201.recruitmentapp.util.Hashing;
...
public class PersonFacade {
    ...
    public void Save(String username, String password, String name, String surname, String ssn, String email, long role) throws Exception {
        String hashedPassword = Hashing.getSHAPassword(password);
        Person mPerson = new Person(username, hashedPassword, name, surname, ssn, email, role);
